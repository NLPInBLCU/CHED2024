...
我们构建了一个具有层级逻辑性的事件类型体系，此任务需要参考给定的事件类型体系，为每个触发词确定其所属的事件类型。
...
|3月5日  |发布训练集、验证集 |
|4月5日  |发布测试集 |
|5月5日  |发布提交测试集触发词识别及事件类型判别结果 |
|5月15日  |公布参赛队伍成绩和排名（开放申诉期，允许参赛队伍对评分结果提出异议） |
|5月31日  |提交中文或英文技术报告（供任务组织者了解参赛队伍的方法并给出反馈，同时技术报告也作为评奖的考虑因素之一，不提交技术报告，不能获奖） |
|5月31日  |评测任务结束 |
|6月5日  |中文或英文技术报告反馈 |
|6月10日  |正式提交中英文评测论文 |
|6月15日  |公布获奖名单 |
|6月25日  |评测论文录用通知（技术报告是评奖重要考量，但未必会被录用） |
|7月1日  |论文Camera Ready提交（录用后的论文将进入ACL/CCL Anthology） |
